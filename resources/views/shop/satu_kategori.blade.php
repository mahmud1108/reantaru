                ...
                <div class="col-12">
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <h1>Kategori {{ $kategori->kategori_nama }}</h1>
                            <ul class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <aside class="sidebar-wrapper">
                            ...
                            <div class="sidebar-body">
                                <ul class="shop-categories">
                                    @foreach ($kategoris as $kategori)
                                        <li><a href={{ route('satu-kategori', $kategori->kategori_nama) }}>{{ $kategori->kategori_nama }}
                        ...
                        @include('components.shop.search') <!-- single sidebar end -->
                                                ...
                                                <div class="product-content-list">
                                                    ...
                                                    <div class="button-group-list">
                                                        <a class="btn-big" href="cart_tambah.php" data-toggle="tooltip"
                                                            title="Masukkan ke Keranjang"><i
                                                                class="lnr lnr-cart"></i>Masukkan
                                                            ke
                                                            Keranjang</a>
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#quick_view{{ $i }}"><span
